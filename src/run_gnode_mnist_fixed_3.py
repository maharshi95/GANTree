...
default_args_str = '-hp hyperparams/digit_mnist_64.py -en mnist_mode_split_fixed_3 -t'
    ...
    # for j in range(0, epochs):
        ...
        with tqdm(total=n_iterations) as pbar:
            for iter_no in range(n_iterations):
                ...
                #     node.reassignLabels(train_data, threshold, reassignLabels = False)
...
def get_recons_data(node, x_batch, l_seed):
    ...
    with tr.no_grad():
        ...
        np.savez('x_recon_post_child0_fixed_3', recon_ch0 = x_recon_post_child0, l_seed_ch0 = l_seed_ch0)
        np.savez('x_recon_post_child1_fixed_3', recon_ch1 = x_recon_post_child1, l_seed_ch1 = l_seed_ch1)

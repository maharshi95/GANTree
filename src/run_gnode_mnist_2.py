...
default_args_str = '-hp hyperparams/digit_mnist_64.py -en mnist_mode_split_2 -t'
    ...
    for j in range(epochs):
        ...
        with tqdm(total=n_iterations) as pbar:
            for iter_no in range(n_iterations):
                ...
                z_batch, x_recon, x_recon_loss, x_clf_loss, loss, preds, time_taken, mu_hinge_loss, x_clf_cross_loss = node.step_train_x_clf(x_clf_train_batch, start_no, end_no, w1 = 1.0, w2 = 1.0, w3 = 1.0, w4 = 100.0)

...
default_args_str = '-hp hyperparams/mnist_0to4_add5.py -en iGANTree_MNIST_add5_dsigma4_trial1 -t'
...
for l in range(len(incremental_nodes_branch)-1):
    ...
    total_inc_train_examples = len(dl_set[train_inc_node_id].data['train'])
    total_inc_test_examples = len(dl_set[train_inc_node_id].data['test'])

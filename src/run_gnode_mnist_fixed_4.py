...
default_args_str = '-hp hyperparams/digit_mnist_64.py -en mnist_mode_split_fixed_4 -t'
...
def get_recons_data(node, x_batch, l_seed):
    ...
    with tr.no_grad():
        ...
        np.savez('x_recon_post_child0_fixed_4', recon_ch0 = x_recon_post_child0, l_seed_ch0 = l_seed_ch0)
        np.savez('x_recon_post_child1_fixed_4', recon_ch1 = x_recon_post_child1, l_seed_ch1 = l_seed_ch1)

...
def weight_dir_path(dir_name):
    return osp.join(weights_base_dir, dir_name)
...
def get_saved_params_path(dir_name, model_name, weight_label, iter_no):
    dir_path = osp.join(weights_base_dir, dir_name)
